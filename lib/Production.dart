...
class UnpopRoute extends StatelessWidget {
  @override
...
//Widget defining the audio demo.
class ProductionTask extends StatefulWidget {
  ProductionTask({Key key, this.title}) : super(key: key);
  ...
  @override
  _ProductionTaskState createState() => _ProductionTaskState();
}

//Credit for this widget goes to the flutter_audio_recorder team.
class _ProductionTaskState extends State<ProductionTask> {
